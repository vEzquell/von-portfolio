      ...
      <div class="order-1 flex justify-center md:order-2 md:justify-end">
        <div class="relative w-full max-w-[460px]">
          ...
          <div class="glass-panel relative overflow-hidden rounded-[34px] border-white/[0.12] p-4 sm:p-5">
            ...
            <div class="group relative [perspective:1600px]">
              <div class="absolute left-4 right-4 top-5 h-full rounded-[30px] bg-black/35 blur-2xl transition duration-500 group-hover:translate-y-4 group-hover:scale-[0.97]"></div>
